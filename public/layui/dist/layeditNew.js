...
function style_html(t, e, i, n) {
    function a() {
        return this.pos = 0, this.token = "", this.current_mode = "CONTENT", this.tags = {
            ...
            if ("/" === a.charAt(a.length - 2) || this.Utils.in_array(l, this.Utils.single_token)) this.tag_type = "SINGLE"; else if ("script" === l) this.record_tag(l), this.tag_type = "SCRIPT"; else if ("style" === l) this.record_tag(l), this.tag_type = "STYLE"; else if ("!" === l.charAt(0)) if (-1 != l.indexOf("[if")) {
                if (-1 != a.indexOf("!IE")) {
                    var o = this.get_unformatted("--\x3e", a);
                    e.push(o)
                }
                this.tag_type = "START"
            } else if (-1 != l.indexOf("[endif")) this.tag_type = "END", this.unindent(); else if (-1 != l.indexOf("[cdata[")) {
                var o = this.get_unformatted("]]>", a);
                e.push(o), this.tag_type = "SINGLE"
            } else {
                var o = this.get_unformatted("--\x3e", a);
                e.push(o), this.tag_type = "SINGLE"
            } else "/" === l.charAt(0) ? (this.retrieve_tag(l.substring(1)), this.tag_type = "END") : (this.record_tag(l), this.tag_type = "START"), this.Utils.in_array(l, this.Utils.extra_liners) && this.print_newline(!0, this.output);
            return e.join("")
    ...
    for (var o = !0; ;) {
        ...
        switch (l.token_type) {
            ...
            case "TK_TAG_SCRIPT":
            case "TK_TAG_STYLE":
                l.print_newline(!1, l.output), l.print_token(l.token_text), l.indent(), l.current_mode = "CONTENT";
                break;
            case "TK_TAG_END":
                o && l.print_newline(!0, l.output), l.print_token(l.token_text), l.current_mode = "CONTENT", o = !0;
                break;
            case "TK_TAG_SINGLE":
                l.print_newline(!1, l.output), l.print_token(l.token_text), l.current_mode = "CONTENT";
                break;
            case "TK_CONTENT":
                "" !== l.token_text && (o = !1, l.print_token(l.token_text)), l.current_mode = "TAG"
        }
        l.last_token = l.token_type, l.last_text = l.token_text
    }
...
function js_beautify(t, e, i, n) {
    ...
    function y() {
        ...
        if ("/" === e) {
            ...
            if ("*" === h.charAt(K)) {
                ...
                return K += 2, ["/*" + a + "*/", "TK_BLOCK_COMMENT"]
            }
            if ("/" === h.charAt(K)) {
                for (a = e; "\r" !== h.charAt(K) && "\n" !== h.charAt(K) && (a += h.charAt(K), !((K += 1) >= h.length));) ;
                return K += 1, n && l(), [a, "TK_COMMENT"]
            }
        }
        if ("'" === e || '"' === e || "/" === e && ("TK_WORD" === g && "return" === b || "TK_START_EXPR" === g || "TK_END_BLOCK" === g || "TK_OPERATOR" === g || "TK_EOF" === g || "TK_END_COMMAND" === g)) {
            ...
            return K += 1, "TK_END_COMMAND" === g && l(), [o + e + o, "TK_STRING"]
        }
        if (f(e, C)) {
    ...
    for (h = t, v = "", g = "TK_START_EXPR", b = "", p = [], L = !1, R = !1, S = !1, k = "\n\r\t ".split(""), E = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_$".split(""), C = "+ - * / % & ++ -- = += -= *= /= %= == === != !== > < >= <= >> << >>> >>>= >>= <<= && &= | || ! !! , : ? ^ ^= |=".split(" "), O = "continue,try,throw,return,var,if,switch,case,default,for,while,break,function".split(","), _ = "BLOCK", x = [_], n = n || 0, K = 0, N = !1; ;) {
        ...
        switch (w) {
            case "TK_START_EXPR":
                R = !1, u("EXPRESSION"), "TK_END_EXPR" === g || "TK_START_EXPR" === g || ("TK_WORD" !== g && "TK_OPERATOR" !== g ? o() : f(v, O) && "function" !== v && o()), s();
                break;
            case "TK_END_EXPR":
                s(), d();
                break;
            case "TK_START_BLOCK":
                u("do" === v ? "DO_BLOCK" : "BLOCK"), "TK_OPERATOR" !== g && "TK_START_EXPR" !== g && ("TK_START_BLOCK" === g ? l() : o()), s(), r();
                break;
            case "TK_END_BLOCK":
                "TK_START_BLOCK" === g ? (a(), c()) : (c(), l()), s(), d();
                break;
            case "TK_WORD":
                if (L) {
                    o(), s(), o();
                ...
                A = "NONE", "TK_END_BLOCK" === g ? f(m.toLowerCase(), ["else", "catch", "finally"]) ? (A = "SPACE", o()) : A = "NEWLINE" : "TK_END_COMMAND" !== g || "BLOCK" !== _ && "DO_BLOCK" !== _ ? "TK_END_COMMAND" === g && "EXPRESSION" === _ ? A = "SPACE" : "TK_WORD" === g ? A = "SPACE" : "TK_START_BLOCK" === g ? A = "NEWLINE" : "TK_END_EXPR" === g && (o(), A = "NEWLINE") : A = "NEWLINE", "TK_END_BLOCK" !== g && f(m.toLowerCase(), ["else", "catch", "finally"]) ? l() : f(m, O) || "NEWLINE" === A ? "else" === b ? o() : ("TK_START_EXPR" !== g && "=" !== b || "function" !== m) && ("TK_WORD" !== g || "return" !== b && "throw" !== b ? "TK_END_EXPR" !== g ? "TK_START_EXPR" === g && "var" === m || ":" === b || ("if" === m && "TK_WORD" === g && "else" === v ? o() : l()) : f(m, O) && ")" !== b && l() : o()) : "SPACE" === A && o(), s(), v = m, "var" === m && (R = !0, S = !1);
                break;
            case "TK_END_COMMAND":
                s(), R = !1;
                break;
            case "TK_STRING":
                "TK_START_BLOCK" === g || "TK_END_BLOCK" === g ? l() : "TK_WORD" === g && o(), s();
                break;
            case "TK_OPERATOR":
                var D = !0, I = !0;
                ...
                "--" === m || "++" === m ? ";" === b ? (D = !0, I = !1) : (D = !1, I = !1) : "!" === m && "TK_START_EXPR" === g ? (D = !1, I = !1) : "TK_OPERATOR" === g ? (D = !1, I = !1) : "TK_END_EXPR" === g ? (D = !0, I = !0) : "." === m ? (D = !1, I = !1) : ":" === m && (D = !!b.match(/^\d+$/)), D && o(), s(), I && o();
                break;
...
layui.define(["layer", "form"], function (t) {
    var e = layui.$, i = layui.layer, n = layui.form, a = (layui.hint(), layui.device()), l = "layui-disabled",
        o = function () {
            var t = this;
            t.index = 0, t.config = {
    ...
    o.prototype.set = function (t) {
        ...
        i = i || {};
        var n = this, l = n.config, o = "layui-layedit", r = e("string" == typeof t ? "#" + t : t),
            c = "LAY_layedit_" + ++n.index, u = r.next("." + o), d = e.extend({}, l, i), f = function () {
                var t = [], e = {};
                return layui.each(d.hideTool, function (t, i) {
                    e[i] = !0
                }), layui.each(d.tool, function (i, n) {
                    k[n] && !e[n] && t.push(k[n])
                }), t.join("")
            }(),
    ...
    var s = function (t, i, n) {
        var a = this, l = t.find("iframe");
        l.css({height: n.height}).on("load", function () {
            var o = l.contents(), s = l.prop("contentWindow"), r = o.find("head"),
                ...
                d = o.find("body");
            r.append(c), d.attr("contenteditable", "true").css({"min-height": n.height}).html(i.value || ""), u.apply(a, [s, l, i, n]), m.call(a, s, t, n)
        })
    }, r = function (t) {
        ...
        var s = t.document, r = e(s.body);
        r.on("keydown", function (t) {
            if (13 === t.keyCode) {
                var e = f(s), n = y(e), a = n.parentNode;
        ...
        }), e(l).parents("form").on("submit", function () {
            var t = r.html();
        ...
        var a = this.document, l = document.createElement(t);
        for (var o in i) l.setAttribute(o, i[o]);
        if (l.removeAttribute("text"), a.selection) {
            var s = n.text || i.text;
            if ("a" === t && !s) return;
            s && (l.innerHTML = s), n.pasteHTML(e(l).prop("outerHTML")), n.select()
        } else {
            var s = n.toString() || i.text;
            if ("a" === t && !s) return;
            s && (l.innerHTML = s), n.deleteContents(), n.insertNode(l)
        }
    }, p = function (t, i) {
        var n = this.document, a = "layedit-tool-active", o = y(f(n)), s = function (e) {
            return t.find(".layedit-tool-" + e)
        };
        i && i[i.hasClass(a) ? "removeClass" : "addClass"](a), t.find(">i").removeClass(a), s("unlink").addClass(l), e(o).parents().each(function () {
            var t = this.tagName.toLowerCase(), e = this.style.textAlign;
            "p" === t && ("center" === e ? s("center").addClass(a) : "right" === e ? s("right").addClass(a) : s("left").addClass(a)), "a" === t && (s("link").addClass(a), s("unlink").removeClass(l))
        })
    }, m = function (t, n, a) {
        var o = t.document, s = e(o.body), r = {
            link: function (i) {
                var n = y(i), l = e(n).parent();
                g.call(s, {
                    href: l.attr("href"),
                ...
                v.call(this, function (i) {
                    h.call(t, "img", {src: i.src, alt: i.alt}, e)
                })
            }, image: function (n) {
                var l = this;
                ...
                var i = a.codeConfig || {hide: !1};
                T.call(s, {hide: i.hide, default: i.default}, function (i) {
                    h.call(t, "pre", {text: i.code, "lay-lang": i.lang}, e)
                })
                ...
                i.open({
                    ...
                    success: function (n, l) {
                        layui.use("upload", function (o) {
                            var s, o = layui.upload, r = n.find('input[name="altStr"]'),
                                c = n.find('input[name="Imgsrc"]'), u = a.uploadImage || {};
                            o.render({
                                ...
                                before: function (t) {
                                    ...
                                    if (i.close(s), 0 == t.code) t.data = t.data || {}, c.val(t.data.src), r.val(t.data.name); else var a = i.open({
                                        ...
                                        area: ["390px", "260px"],
                                        offset: "t",
                                        content: t.data.name + "<div style='text-align:center;'><img  src='../.." + t.data.src + "' style='max-height:80px'/></div><p style='text-align:center'>确定使用该文件吗？</p>",
                                        btn: ["确定", "取消"],
                                        success: function () {
                                        },
                                        yes: function () {
                                            t.data = t.data || {}, c.val("../.." + t.data.src), r.val(t.data.name), i.close(a)
                                        },
                                        btn2: function () {
                                            i.close(a)
                                        }
                            ...
                            }), n.find(".layui-btn-primary").on("click", function () {
                                i.close(l)
                            }), n.find(".layedit-btn-yes").on("click", function () {
                                var a = "";
                                "" != n.find('input[name="imgWidth"]').val() && (a += "width:" + n.find('input[name="imgWidth"]').val() + ";"), "" != n.find('input[name="imgHeight"]').val() && (a += "height:" + n.find('input[name="imgHeight"]').val() + ";"), h.call(t, "img", {
                                    src: c.val(),
                                    alt: r.val(),
                                    style: a
                                }, e), i.close(l)
                ...
                i.open({
                    ...
                    success: function (l, o) {
                        layui.use("upload", function (s) {
                            var r, c = l.find('input[name="video"]'), u = l.find('input[name="cover"]'),
                                s = layui.upload, d = a.uploadImage || {}, f = a.uploadVideo || {};
                            s.render({
                                elem: "#LayEdit_InsertImage",
                                url: d.url,
                                method: d.type,
                                ...
                                before: function (t) {
                                    ...
                                    if (i.close(r), 0 == t.code) t.data = t.data || {}, u.val(t.data.src); else var a = i.open({
                                        ...
                                        btn: ["确定", "取消"],
                                        yes: function () {
                                            t.data = t.data || {}, u.val(t.data.src), i.close(a)
                                        },
                                        btn2: function () {
                                            i.close(a)
                                        }
                                ...
                                before: function (t) {
                                    ...
                                    if (i.close(r), 0 == t.code) t.data = t.data || {}, c.val(t.data.src); else var a = i.open({
                                        type: 1,
                                        anim: 2,
                                        icon: 5,
                                        title: "提示",
                                        ...
                                        btn: ["确定", "取消"],
                                        yes: function () {
                                            t.data = t.data || {}, c.val(t.data.src), i.close(a)
                                        },
                                        btn2: function () {
                                            i.close(a)
                                        }
                                ...
                                i.close(o)
                            }), l.find(".layedit-btn-yes").on("click", function () {
                                var a = y(n);
                                e(a).parent();
                                h.call(t, "p", {text: '&nbsp;<video src="' + c.val() + '" poster="' + u.val() + '" controls="controls" >您的浏览器不支持video播放</video>&nbsp;'}, n), i.close(o)
                            })
                        })
                    }
                })
                ...
                a = style_html(a, 4, " ", 80), i.open({
                    ...
                    success: function (e, n) {
                        ...
                        l.setFontSize(14), l.session.setMode("ace/mode/html"), l.setTheme("ace/theme/tomorrow"), l.setValue(a), l.setOption("wrap", "free"), l.gotoLine(0), e.find(".layui-btn-primary").on("click", function () {
                            i.close(n)
                        }), e.find(".layedit-btn-yes").on("click", function () {
                            t.document.body.innerHTML = l.getValue(), i.close(n)
                ...
                _.call(this, function (t) {
                    o.execCommand("forecolor", !1, t), setTimeout(function () {
                        s.focus()
                    }, 10)
                })
                ...
                }, i = {}, n = {}, l = e.code, r = e.text, c = function () {
                    return layui.each(l, function (t, e) {
                        i[t] = e
                    }), i
                }(), u = function () {
                ...
                x.call(this, {fonts: c, texts: u}, function (t) {
                    o.execCommand("formatBlock", !1, "<" + t + ">"), setTimeout(function () {
                        s.focus()
                    }, 10)
                })
            }, anchors: function (e) {
                b.call(s, {}, function (i) {
                    h.call(t, "a", {name: "#" + i.text, text: " ", class: "anchor"}, e)
                })
            }, addhr: function (e) {
                h.call(t, "hr", {}, e)
            }, help: function () {
        ...
        }, c = n.find(".layui-layedit-tool"), u = function () {
            var i = e(this), n = i.attr("layedit-event"), a = i.attr("lay-command");
            if (!i.hasClass(l)) {
                s.focus();
                var u = f(o), d = u.commonAncestorContainer;
                a ? (/justifyLeft|justifyCenter|justifyRight/.test(a) && "BODY" === d.parentNode.tagName && o.execCommand("formatBlock", !1, "<p>"), o.execCommand(a), setTimeout(function () {
                    s.focus()
                }, 10)) : r[n] && r[n].call(this, u, o), p.call(t, c, i)
            }
        }, d = /image/;
        c.find(">i").on("mousedown", function () {
            ...
            p.call(t, c), i.close(v.index), i.close(_.index), i.close(x.index)
            ...
            if (null != t) switch (t.target.tagName) {
                case "IMG":
                    i.open({
                        ...
                        success: function (n, l) {
                            var o = a.uploadImage || {};
                            return layui.use("upload", function (t) {
                                var e, a = n.find('input[name="altStr"]'), l = n.find('input[name="Imgsrc"]');
                                t = layui.upload, t.render({
                                    ...
                                    before: function (t) {
                                        ...
                                        if (i.close(e), 0 == t.code) t.data = t.data || {}, l.val(t.data.src), a.val(t.data.name); else var s = i.open({
                                            ...
                                            btn: ["确定", "取消"],
                                            yes: function () {
                                                t.data = t.data || {}, l.val(t.data.src), a.val(t.data.name), i.close(s)
                                            },
                                            btn2: function () {
                                                i.close(s)
                                            }
                    ...
                    break;
                default:
                    var n = t.toElement, l = t.toElement.parentNode;
                    i.open({
                        type: 1,
                        title: !1,
                        offset: [t.clientY + "px", t.clientX + "px"],
                        ...
                        success: function (o, s) {
                            var r = a.calldel;
                            o.find(".layui-btn-primary").on("click", function () {
                                var t = e(this), a = t.attr("lay-command");
        ...
        var l = e.dmode, o = this, s = i.open({
            ...
            success: function (e, s) {
                ...
                n.render("radio"), e.find(".layui-btn-primary").on("click", function () {
                    i.close(s), setTimeout(function () {
                        o.focus()
                    }, 10)
                }), n.on("submit(layedit-link-yes)", function (e) {
                    i.close(t.index), a && a(e.field)
                })
            }
        });
        t.index = s
        ...
        return t.hide = t.hide || function (n) {
            ...
            tips: 1, time: 0, skin: "layui-box layui-util-face", maxWidth: 500, success: function (l, o) {
                l.css({marginTop: -4, marginLeft: -10}).find(".layui-clear>li").on("click", function () {
                    n && n({src: a[this.title], alt: this.title}), i.close(o)
        ...
        return t.hide = t.hide || function (n) {
            ...
            tips: 1, time: 0, skin: "layui-box layui-util-face", success: function (a, l) {
                a.css({marginTop: -4, marginLeft: -10}).find(".layui-clear>li").on("click", function () {
                    n && n(this.title), i.close(l)
                }), e(document).off("click", t.hide).on("click", t.hide)
            }
        })
    }, x = function t(n, a) {
        t.hide = t.hide || function (n) {
            "fontFomatt" !== e(n.target).attr("layedit-event") && i.close(t.index)
        }, t.index = i.tips(function () {
            var t = [];
            return layui.each(n.fonts, function (e, i) {
                t.push('<li title="' + n.fonts[e] + '"><' + n.fonts[e] + ">" + n.texts[e] + "</" + n.fonts[e] + "></li>")
            }), '<ul class="layui-clear" style="width: max-content;">' + t.join("") + "</ul>"
        }(), this, {
            tips: 1, time: 0, skin: "layui-box layui-util-font", success: function (l, o) {
                l.css({marginTop: -4, marginLeft: -10}).find(".layui-clear>li").on("click", function () {
                    a && a(this.title, n.fonts), i.close(o)
                }), e(document).off("click", t.hide).on("click", t.hide)
            }
        })
    }, T = function t(e, a) {
        ...
        e.hide && (l = ['<li class="layui-form-item" style="display:none">', '<label class="layui-form-label">请选择语言</label>', '<div class="layui-input-block">', '<select name="lang">', '<option value="' + e.default + '" selected="selected">', e.default, "</option>", "</select>", "</div>", "</li>"].join(""));
        var o = this, s = i.open({
            type: 1,
            id: "LAY_layedit_code",
            area: "550px",
            ...
            success: function (l, s) {
                n.render("select"), l.find(".layui-btn-primary").on("click", function () {
                    i.close(s), o.focus()
                }), n.on("submit(layedit-code-yes)", function (n) {
                    i.close(t.index), a && a(n.field, e.hide, e.default)
                })
            }
        });
        t.index = s
